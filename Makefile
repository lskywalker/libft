...
#                                                    +#+                       #
#    Created: 2019/11/04 13:06:42 by lsmit          #+#    #+#                 #
#    Updated: 2019/12/10 13:15:52 by lsmit         ########   odam.nl          #
#                                                                              #
# **************************************************************************** #
...
O = ft_atoi.o ft_bzero.o ft_calloc.o ft_isalnum.o ft_isalpha.o ft_isascii.o \
...
O_BONUS = ft_lstadd_back_bonus.o ft_lstadd_front_bonus.o ft_lstclear_bonus.o \
